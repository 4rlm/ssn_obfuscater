...
Gem::Specification.new do |spec|
  spec.name          = "ssn_obfuscater"
  spec.version       = SsnObfuscater::VERSION
  spec.authors       = ["Adam Booth"]
  spec.email         = ["4rlm@protonmail.ch"]

  spec.summary       = %q{Protects client data by detecting and obfuscating social security numbers (ssn)}
  spec.description   = %q{Protects client data by detecting and obfuscating social security numbers (ssn).}

  spec.homepage      = 'https://github.com/4rlm/ssn_obfuscater'
  spec.license       = "MIT"
